...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Mudavath Aravind", url: "https://mudavath-aravind.vercel.app" }],
  creator: "Mudavath Aravind",
  metadataBase: new URL("https://mudavath-aravind.vercel.app"),
  openGraph: {
    title: "Mudavath Aravind — Embedded Systems Engineer",
    description: "Portfolio of Mudavath Aravind, Embedded Systems Engineer based in Hyderabad, India.",
    url: "https://mudavath-aravind.vercel.app",
